<template>
    ...
    <div class="grid-container">
        <div class="grid-item" v-for="kupac in kupci" :value="kupac._id" :key="kupac._id">
            {{ kupac.first_name }} {{ kupac.last_name }}
        </div>
    </div>
</template>
<script>
    ...
    export default{
        ...
        methods:{
            async dohvatiKupce(){
                try{
                    const response=await axios.get('http://localhost:3000/kupci');
